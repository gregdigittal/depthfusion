...
1. `session` / `2026-05-18-skillforge-session` (score=38.9881)
...
--- SESSION START at 05:30:55 ---
Pr
2. `session` / `2026-05-17-skillforge-session` (score=33.4761)
...
3. `session` / `2026-05-16-skillforge-session` (score=29.5514)
   > # Session: 2026-05-16
**Date:** 2026-05-16
**Started:** 20:33
**Last Updated:** 21:01
...
Project: skillforg
4. `session` / `2026-05-17-depthfusion-session` (score=26.1221)
...
Trigger: context limit reached
Hook Input: {"session_id":"e00bf648-afe7-4179-9e6b-74316b665098","transcript_path":"/home/gregmorris/.
5. `session` / `2026-05-18-tito-apps-session` (score=26.6676)
   > --- COMPACTION EVENT at 05:31:20 ---
Project: tito-apps
Directory: /home/gregmorris/projects/tito-apps
Trigger: context limit reached
...
Trigger: context limit reached
Hook Input: {"session_id":"ba38b370-9394-43a1-bdec-8194d0dee4e8","transcript_path":"/home/gregmorris/.clau
2. `session` / `2026-05-17-depthfusion-session` (score=26.0648)
   > --- COMPACTION EVENT at 03:52:06 ---
Project: depthfusion
Directory: /home/gregmorris/projects/depthfusion
Trigger: context limit reached
Hook Input: {"session_id":"e00bf648-afe7-4179-9e6b-74316b665098","transcript_path":"/home/gregmorris/.
3. `rule` / `commit-review#3` (score=24.3716)
   > ## The 3-tier workflow
...
- Round 1: independen
4. `session` / `2026-05-18-depthfusion-session` (score=22.1341)
   > # Session: 2026-05-18
**Date:** 2026-05-18
**Started:** 05:39
**Last Updated:** 08:20
...
5. `rule` / `agent-hub-pm-contract#4` (score=21.013)
