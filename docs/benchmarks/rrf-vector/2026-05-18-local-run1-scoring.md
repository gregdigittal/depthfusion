...
1. `session` / `2026-05-18-skillforge-session` (score=48.9917)
...
--- SESSION START at 05:30:55 ---
Pr
2. `session` / `2026-05-17-skillforge-session` (score=37.1416)
...
3. `session` / `2026-05-16-skillforge-session` (score=33.8308)
   > # Session: 2026-05-16
**Date:** 2026-05-16
**Started:** 20:33
**Last Updated:** 21:01
...
Project: skillforg
4. `session` / `2026-05-18-depthfusion-session` (score=30.1875)
   > # Session: 2026-05-18
**Date:** 2026-05-18
**Started:** 05:39
**Last Updated:** 13:17
...
5. `session` / `2026-05-17-depthfusion-session` (score=29.9623)
...
1. `session` / `2026-05-18-skillforge-session` (score=50.8526)
   > --- SESSION START at 05:30:55 ---
Project: skillforge
Directory: /home/gregmorris/projects/skillforge
--- SESSION START at 05:30:55 ---
...
--- SESSION START at 05:30:55 ---
Pr
2. `session` / `2026-05-17-skillforge-session` (score=40.6898)
   > --- COMPACTION EVENT at 03:53:27 ---
Project: skillforge
Directory: /home/gregmorris/projects/skillforge
Trigger: context limit reached
Hook Input: {"session_id":"097ee9a5-0a7b-4aaf-99c4-fb37a9c5b437","transcript_path":"/home/gregmorris/.cl
3. `session` / `2026-05-16-skillforge-session` (score=39.0728)
   > # Session: 2026-05-16
**Date:** 2026-05-16
**Started:** 20:33
**Last Updated:** 21:01
...
--- COMPACTION EVENT at 10:07:15 ---
Project: skillforg
4. `session` / `2026-05-18-depthfusion-session` (score=34.5185)
   > # Session: 2026-05-18
**Date:** 2026-05-18
**Started:** 05:39
**Last Updated:** 13:17
...
5. `session` / `2026-05-17-depthfusion-session` (score=30.4901)
   > --- COMPACTION EVENT at 03:52:06 ---
Project: depthfusion
Directory: /home/gregmorris/projects/depthfusion
Trigger: context limit reached
...
1. `session` / `2026-05-18-depthfusion-session` (score=30.9295)
   > # Session: 2026-05-18
**Date:** 2026-05-18
**Started:** 05:39
**Last Updated:** 13:17
...
2. `session` / `2026-05-17-depthfusion-session` (score=27.914)
   > --- COMPACTION EVENT at 03:52:06 ---
Project: depthfusion
Directory: /home/gregmorris/projects/depthfusion
Trigger: context limit reached
Hook Input: {"session_id":"e00bf648-afe7-4179-9e6b-74316b665098","transcript_path":"/home/gregmorris/.
3. `rule` / `commit-review#3` (score=27.1387)
   > ## The 3-tier workflow
...
- Round 1: independen
4. `session` / `2026-05-18-tito-apps-session` (score=24.963)
...
5. `rule` / `agent-hub-pm-contract#4` (score=23.3439)
