...
export function SettingsPage({ onBack }: SettingsPageProps) {
  const [serverUrl, setServerUrlState] = useState<string>('http://176.9.147.206:7300')
  const [inputUrl, setInputUrl] = useState<string>('http://176.9.147.206:7300')
        ...
        <div className="df-card">
          ...
          <div className="df-card__body">
            ...
            <input
              ...
              placeholder="http://176.9.147.206:7300"
              className="df-input"
              onKeyDown={(e) => {
